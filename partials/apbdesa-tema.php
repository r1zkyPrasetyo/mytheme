					...
					<div class="keuangan-col bgwhite bordergrey1">
						...
						<div class="keuangan-box">
							...
							<table class="table-anggaran" style="width:100%;">
								<tbody>
									<tr>
										<td style="text-align:center;font-size:95%;">Anggaran</td>
										<td style="text-align:center;font-size:95%;">Realisasi</td>
									</tr>
									<tr>
										<td style="font-size:90%;letter-spacing:-0.3px;">Rp <?= number_format($subdata['realisasi']); ?></td>
										<td style="font-size:90%;letter-spacing:-0.3px;">Rp <?= number_format($subdata['anggaran']); ?></td>
									</tr>
								</tbody>
							</table>
							<div class="progress-anggaran">
								<progress max="100" value="<?= $subdata['persen'] ?>" class="php">
									<div class="progress-bar" role="progressbar" style="width: <?= $subdata['persen'] ?>%"
										aria-valuenow="<?= $subdata['persen'] ?>" aria-valuemin="0" aria-valuemax="100">
									</div>
								</progress>
